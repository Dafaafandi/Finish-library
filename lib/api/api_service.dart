...
class ApiService {
  ...
  Future<Map<String, dynamic>> register(String name, String username,
    ...
    try {
      ...
      if (e.response?.data != null) {
        ...
        message = 'Data sudah digunakan (email atau username)';
      } else if (e.response?.statusCode == 422) {
      ...
      return {'success': false, 'message': message, 'data': e.response?.data};
    } catch (e) {
      return {
        'success': false,
    ...
    try {
      ...
      if (response.statusCode == 200) {
        if (response.data is Map<String, dynamic> &&
          ...
          // Clean up double slashes and ensure proper URL format
          String fullUrl = 'http://perpus-api.mamorasoft.com/$filePath';
          fullUrl =
              fullUrl.replaceAll('//', '/').replaceFirst('http:/', 'http://');
          return fullUrl;
        }
